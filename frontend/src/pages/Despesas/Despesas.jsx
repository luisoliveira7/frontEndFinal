...
export default function Despesas() {
  ...
  function despesasOrdenadas() {
    if (!ordenarPor) return despesas;

    const copia = [...despesas];
    copia.sort((a, b) => {
  ...
  function despesasPaginadas() {
    const ordenadas = despesasOrdenadas();
    const inicio = (paginaAtual - 1) * itensPorPagina;
    return ordenadas.slice(inicio, inicio + itensPorPagina);
  }

  function totalPaginas() {
    return Math.ceil(despesas.length / itensPorPagina);
  }
  ...
  return (
    <div>
      ...
      <form
        ...
        className="row g-2 mb-4 align-items-center bg-light p-3 rounded"
      >
        <div className="col-md-2">
          <select
            className="form-select"
          ...
          <div className="table-responsive">
            <table className="table table-striped table-bordered">
              <thead className="table-dark">
                <tr>
                  <th role="button" onClick={() => ordenar("descricao")}>
                    Descrição
                  </th>
                  <th role="button" onClick={() => ordenar("valor")}>
                    Valor
                  </th>
                  <th role="button" onClick={() => ordenar("data")}>
                    Data
                  </th>
                  <th>Status</th>
                  <th>Categoria</th>
